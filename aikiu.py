...
def _prompt_vigia(texto_usuario: str, nombre: str = "Marta") -> str:
    ...
    return (
        ...
        f"menciona cualquier SÍNTOMA físico reciente aunque lo minimice — no solo dolor: "
        f"golpes, tropezones, 'me duele un poco', náuseas, vómitos, mareo, fiebre, falta de "
        f"aire, debilidad, algo que le cayó mal — la familia debe enterarse aunque "
        f"{nombre} le reste importancia\n"
