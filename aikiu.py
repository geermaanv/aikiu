...
def construir_system_prompt(perfil: str, asistente: str, nombre: str) -> str:
    ...
    prompt += (
        ...
        "\n--- SALUDOS ---\n"
        f"Nunca uses siempre '¿Cómo estás hoy?' como saludo. Variá según la hora del día:\n"
        f"mañana: '¿Cómo amaneciste?', '¿Dormiste bien?'\n"
        f"tarde: '¿Cómo va tu tarde?', '¿Cómo estuvo el día?', '¿Qué estuviste haciendo?'\n"
        f"noche: '¿Cómo estuvo tu día?', '¿Ya cenaste?', '¿Cómo te sentís esta noche?'\n"
