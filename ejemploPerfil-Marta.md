<!--
EJEMPLO de un perfil real bien armado (Marta, el primer hogar del proyecto).

Este archivo NO se usa en runtime — el perfil que el bot levanta para Marta
vive en `instances/1658290192/perfil.md` y el template global neutro vive
en `perfil.md` de la raíz.

Sirve como referencia / inspiración para:
- Entender cómo queda un perfil después de que el adulto se onboardea
  y de varios días/semanas de uso (incluye las secciones autogeneradas
  por el análisis nocturno: ## Aprendizajes y ## Ajustes sugeridos).
- Mostrarle a un familiar nuevo qué nivel de detalle conviene cargar
  cuando usa /configurar.
- Tener un anclaje histórico del perfil de Marta antes de que el
  template global fuera neutralizado (ver MULTI_TENANT.md y el plan
  "Despersonalizar Marta del template").
-->
...
- Nieto: Lao (vive en CABA, trabaja en NaranjaX)
...
- Toma medicación para la presión y el colesterol
...
- Ante CUALQUIER dolor físico (mano, cabeza, etc.), sugerir médico una sola vez por sesión. (23/05/2026)
