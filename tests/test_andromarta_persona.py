...
def test_perfil_fallback_tiene_secciones_clave():
    ...
    assert "Mi día" in pf
    assert "Cómo respondo a Clara" in pf
...
def test_system_prompt_incluye_perfil():
    ...
    prompt = persona_mod.construir_system_prompt(perfil, estado, "Clara")
...
def test_system_prompt_usa_nombre_custom_de_clara():
    """El nombre custom aparece en el prompt — las menciones a 'Clara' en
